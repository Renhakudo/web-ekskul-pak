    ...
    <div className="min-h-screen bg-[#f8fafc] pb-24">
      ...
      <div className="sticky top-0 z-50 bg-white border-b-4 border-slate-900 shadow-sm px-4 md:px-8 h-20 flex items-center justify-between">
        <div className="flex items-center gap-4">
            <Button variant="ghost" onClick={() => router.push(`/admin/classes/${classId}`)} className="h-12 w-12 p-0 border-2 border-transparent hover:border-slate-900 hover:bg-slate-100 rounded-xl">
