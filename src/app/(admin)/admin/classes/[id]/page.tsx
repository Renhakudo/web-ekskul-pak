...
import { ArrowLeft, Plus, FileText, Video, Trash2, Loader2, Briefcase, Calendar, Pencil } from 'lucide-react'
...
export default function ClassAdminPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const handleDelete = async (table: 'materials' | 'assignments', itemId: string) => {
